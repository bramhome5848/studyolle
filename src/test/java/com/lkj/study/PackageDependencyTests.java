...
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAnyPackage("com.lkj.study.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.lkj.study.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.lkj.study.modules.(*)..")
